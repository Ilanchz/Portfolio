      ...
      <div className="flex-1">
              ...
              {skillsData.map((skill, index) => (
                <div key={index} className="bg-gray-700 p-4 md:p-6 rounded-lg shadow-lg text-center flex flex-col items-center w-72 transform transition-transform hover:scale-105 hover:shadow-xl">
                  <div className="flex items-center justify-center mb-4 space-x-1 md:space-x-2">
                    ...
                    {skill.icon2 && <img src={skill.icon2} alt={skill.name} className="w-16 h-16 md:w-20 md:h-20" />}
                  </div>
              ...
              {projectsData.map((project, index) => {
                ...
                return (
                  <div
                    key={index}
                    ref={projectRef}
                    className={`bg-gray-800 p-4 md:p-6 rounded-lg shadow-lg flex flex-col items-start w-full md:w-2/3 h-auto transform transition-transform hover:scale-105 hover:shadow-xl project-card ${projectInView ? 'visible' : ''}`}
                  >
        ...
        <footer className="bg-gray-800 text-white py-6">
          <div className="container mx-auto flex flex-col items-center justify-center space-y-4">
            ...
            <h4 className='font-raleway'><a href="https://youtu.be/xvFZjo5PgG0">Click here for free Chatgpt plus API</a> </h4>
          </div>
        </footer>
      </div>
    </div>
